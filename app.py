...
from secure_db import initialize_secure_db, db_manager

# Only initialize if not already connected
if not db_manager.is_connected:
    secure_db_initialized = initialize_secure_db()
else:
    print("✅ Secure database connection already active")
    secure_db_initialized = True
...
if __name__ == '__main__': 
    try:
        ...
        from secure_db import cleanup_secure_db
        cleanup_secure_db()
