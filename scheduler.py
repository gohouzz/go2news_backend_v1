...
class ArticleFetcher:
    ...
    def fetch_articles_from_api(self, country, from_date, to_date):
        ...
        try:
            logger.info(f"Fetching articles for {country} using latest API")
            
            # Use NewsDataApiClient latest API for fetching recent articles
            response = self.api_client.latest_api(
                country=country,
                timeframe=5,
                scroll=True,
                max_result=50
            ...
            # Check if response is a dictionary and has results
    ...
    def save_articles_to_database(self, articles):
        ...
        try:
            ...
            # Don't let database errors stop the scheduler
            return 0
    ...
    def start_scheduler(self):
        ...
        try:
            ...
            self.scheduler.add_job(
                ...
                id='article_fetcher',
                name='Fetch articles every 15 minutes',
